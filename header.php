...
*  Please see LICENSE file for your rights under this license. */
    ...
    exec('/usr/local/bin/fanspeed.sh $fspeed $fsd1 $fsd2 $fsd3 $fset1 $fset2 $fset3', $fresult);
        ...
        <section class="sidebar">
			...
			elseif ($fresult[0] >= $fresult[1] || $fresult[0] < 0){
			    echo "text-yellow";
                        ...
                        if($fspeed >= 0)
                        {
                            echo "\"></i> Fan Speed:&nbsp;&nbsp;" . $fresult[0] . "</span>";
                        }
                        else
                        {
                            echo "\"></i> Fan Speed:&nbsp;&nbsp; N/A</span>";
                        }
                    ?>
		    <br/>
		    <?php
		    echo "<span><i class=\"fas fa-fan ";
		    echo "text-green-light";
		    echo "\"></i> " . $fresult[1] . "/" . $fresult[4] ." | " . $fresult[2] ."/" . $fresult[5] . " | " . $fresult[3] . "/" . $fresult[6] . "</span>";
		    ?>
                </div>
            </div>
