...
function refreshData() {
    tableApi.ajax.url("api.php?getAllFanSpeedData&_="+Date.now()).load();
//    updateSessionTimer();
}
...
$(document).ready(function() {
    ...
    var APIstring = "api.php?getAllFanSpeedData&PHP";
    ...
    tableApi = $("#all-queries").DataTable( {
        ...
        "columns": [
            ...
            { "render": function (data, type, full, meta) { {return data + "%";} }},
            {"render" : function (data, type, full, meta) { {return data + "°C";} }}
        ],
